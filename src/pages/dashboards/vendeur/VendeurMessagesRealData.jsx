...
const VendeurMessagesRealData = () => {
  ...
  const loadConversations = async () => {
    try {
      ...
      // Simuler conversations (en attente de vraie table)
      const mockConversations = [
        {
          id: 1,
          buyer_name: 'Amadou Diallo',
          buyer_email: 'amadou@example.com',
          buyer_avatar: null,
          property_title: 'Villa Moderne Almadies',
          property_id: 'ALM-001',
          last_message: 'Bonjour, est-ce que la propriété est toujours disponible ?',
          last_message_time: new Date(Date.now() - 3600000).toISOString(), // 1h ago
          unread_count: 2,
          is_pinned: false,
          is_archived: false,
          status: 'active'
        ...
        {
          id: 2,
          buyer_name: 'Fatou Seck',
          buyer_email: 'fatou@example.com',
          buyer_avatar: null,
          property_title: 'Terrain Résidentiel Thiès',
          property_id: 'THI-005',
          last_message: 'Merci pour votre réponse rapide ! Je suis très intéressée.',
          last_message_time: new Date(Date.now() - 7200000).toISOString(), // 2h ago
          unread_count: 0,
          is_pinned: true,
          is_archived: false,
          status: 'active'
        ...
        {
          id: 3,
          buyer_name: 'Moussa Kane',
          buyer_email: 'moussa@example.com',
          buyer_avatar: null,
          property_title: 'Appartement Centre-Ville Dakar',
          property_id: 'DAK-012',
          last_message: 'Pouvons-nous planifier une visite ce weekend ?',
      ...
      // Stats
      const unreadCount = mockConversations.reduce((sum, c) => sum + c.unread_count, 0);
      setStats({
      ...
      const mockMessages = [
        {
          ...
          sender_type: 'buyer',
          content: 'Bonjour, je suis intéressé par cette propriété. Est-elle toujours disponible ?',
        ...
        },
        {
          ...
          conversation_id: conversationId,
          sender_type: 'vendor',
          content: 'Bonjour ! Oui, la propriété est toujours disponible. Souhaitez-vous planifier une visite ?',
          sent_at: new Date(Date.now() - 6900000).toISOString(),
          read_at: new Date(Date.now() - 6800000).toISOString(),
          attachments: []
        },
        {
          id: 3,
          conversation_id: conversationId,
          sender_type: 'buyer',
          content: 'Oui, ce serait parfait ! Êtes-vous disponible samedi matin ?',
        ...
        },
        {
          ...
          conversation_id: conversationId,
          sender_type: 'buyer',
          content: 'Aussi, pourriez-vous m\'envoyer plus de photos de la cuisine et de la salle de bain ?',
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      // Mettre à jour last_message dans conversation
      setConversations(prev => prev.map(c =>
