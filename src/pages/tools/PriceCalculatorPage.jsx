...
const PriceCalculatorPage = () => {
  ...
  const amenities = [
    ...
    { value: 'school', label: 'École Ï  proximité', bonus: 0.08 },
    { value: 'hospital', label: 'Hôpital Ï  proximité', bonus: 0.07 },
    { value: 'market', label: 'Marché Ï  proximité', bonus: 0.05 }
  ];
          ...
          <div className="container mx-auto px-6 relative">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                ...
                <br />
                <span className="text-blue-600 font-semibold">Données certifiées â€¢ Calcul ROI â€¢ Protection anti-fraude</span>
              </p>
            </motion.div>
          </div>
        </section>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
                            ...
                            <div className="text-sm text-blue-700">
                              ...
                              <div>Situé Ï  {result.location}</div>
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            >
              <h2 className="text-3xl font-bold text-white mb-6">
                Prêt Ï  investir en toute sécurité ?
              </h2>
