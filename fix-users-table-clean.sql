-- Script de correction urgente de la base de donnees
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Colonne phone existe deja';
    END IF;
END $$;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Colonne full_name existe deja';
    END IF;
END $$;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Colonne role existe deja';
    END IF;
END $$;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Colonne status existe deja';
    END IF;
END $$;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Colonne verification_status existe deja';
    END IF;
END $$;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Colonne country existe deja';
    END IF;
END $$;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Colonne region existe deja';
    END IF;
END $$;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Colonne department existe deja';
    END IF;
END $$;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Colonne commune existe deja';
    END IF;
END $$;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Colonne address existe deja';
    END IF;
END $$;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Colonne last_active_at existe deja';
    END IF;
END $$;

-- Mettre a jour les donnees existantes pour eviter les valeurs NULL
UPDATE users SET
...
-- Creer un index sur les colonnes importantes
