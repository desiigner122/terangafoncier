...
const BlockchainAboutPage = () => {
  ...
  const coreValues = [
    ...
    },
    {
      icon: Heart,
      title: "Impact Social",
      description: "Notre mission est de démocratiser l'accès à la propriété foncière pour tous les Sénégalais, notamment la diaspora.",
  ...
  const timeline = [
    ...
    },
    {
      ...
      description: "Ouverture des services à la diaspora sénégalaise mondiale",
      icon: Globe,
      color: "bg-purple-500"
    },
    {
  ...
  const partnerships = [
    { name: "Ministère de l'Urbanisme", type: "Institution", logo: "/api/placeholder/80/80" },
    { name: "Banque Atlantique", type: "Financier", logo: "/api/placeholder/80/80" },
    { name: "Ethereum Foundation", type: "Technologique", logo: "/api/placeholder/80/80" },
    { name: "APIX", type: "Promotion Investissement", logo: "/api/placeholder/80/80" },
    { name: "Chambre de Commerce", type: "Business", logo: "/api/placeholder/80/80" },
    { name: "Ordre des Notaires", type: "Juridique", logo: "/api/placeholder/80/80" }
  ];
  ...
  const testimonials = [
    ...
    {
      quote: "Grâce à leur plateforme, j'ai pu investir depuis la France en toute sérénité. Le suivi IA de ma construction est exceptionnel.",
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl lg:text-2xl text-white/90 mb-8 leading-relaxed">
                Depuis 2019, nous connectons le Sénégal au monde grâce à la première plateforme 
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Démocratiser l'accès à la propriété foncière grâce à la technologie blockchain
              </p>
            </motion.div>
                ...
                <Card className="border-0 bg-gradient-to-br from-blue-50 to-purple-50 p-8">
                  ...
                  <CardContent>
                    <p className="text-gray-700 leading-relaxed text-lg">
                      Faciliter l'accès à la propriété foncière pour tous les Sénégalais, 
                      qu'ils vivent au pays ou à l'étranger, en utilisant la technologie blockchain 
                ...
                <Card className="border-0 bg-gradient-to-br from-emerald-50 to-teal-50 p-8">
                  ...
                  <CardContent>
                    <p className="text-gray-700 leading-relaxed text-lg">
                      ...
                      à l'immobilier, en créant un écosystème où chaque citoyen peut investir, 
                      construire et prospérer grâce à des outils numériques innovants.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
