          ...
          {loadingSubscription ? (
            ...
            <>
              ...
              <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">
                <CardHeader>
                  ...
                  <CardDescription className="text-blue-100">
                    Votre plan et vos limites
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-2xl font-bold">Plan {currentSubscription?.plan || 'Gratuit'}</p>
                      <p className="text-blue-100">
                        {currentSubscription?.plan === 'Gratuit' && 'Limité à 3 biens'}
                        {currentSubscription?.plan === 'Basique' && 'Jusqu\'à 10 biens'}
                        {currentSubscription?.plan === 'Pro' && 'Jusqu\'à 50 biens'}
                        {currentSubscription?.plan === 'Premium' && 'Biens illimités'}
                      </p>
                    </div>
                    <div className="text-right">
                      <p className="text-3xl font-bold">
                        {currentSubscription?.price === 0 ? 'Gratuit' : `${currentSubscription?.price?.toLocaleString()} FCFA`}
                      </p>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {propertiesCount} / {currentSubscription?.properties_limit === 0 ? '∞' : currentSubscription?.properties_limit} biens
                      </span>
                    </div>
                    <Progress 
                      value={currentSubscription?.properties_limit === 0 ? 0 : (propertiesCount / currentSubscription?.properties_limit) * 100} 
                  ...
                  {currentSubscription?.next_billing_date && (
                    <div className="flex items-center gap-2 text-sm text-blue-100">
                      ...
                      Prochain renouvellement: {new Date(currentSubscription.next_billing_date).toLocaleDateString('fr-FR')}
                    </div>
                  )}
                </CardContent>
              </Card>
              ...
              <div className="grid grid-cols-3 gap-4">
                {/* Basique Plan */}
                <Card className={currentSubscription?.plan === 'Basique' ? 'border-2 border-blue-600' : ''}>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      Plan Basique
                      {currentSubscription?.plan === 'Basique' && (
                        <Badge className="bg-blue-600">Actuel</Badge>
                      )}
                    </CardTitle>
                    <CardDescription>Pour démarrer votre activité</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                    ...
                    {currentSubscription?.plan === 'Basique' ? (
                      ...
                      <Button 
                        onClick={() => handleUpgrade('Basique', 10000, 10, 100, 5)}
                ...
                {/* Pro Plan */}
                <Card className={currentSubscription?.plan === 'Pro' ? 'border-2 border-purple-600 shadow-lg' : 'border-2 border-purple-200'}>
                  <CardHeader className="bg-gradient-to-r from-purple-50 to-blue-50">
                    <CardTitle className="flex items-center gap-2">
                      ...
                      <Badge variant="secondary" className="ml-auto">Populaire</Badge>
                    </CardTitle>
                    <CardDescription>Pour professionnels actifs</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      <p className="text-3xl font-bold text-purple-600">25,000 FCFA</p>
                      <p className="text-sm text-gray-600">par mois</p>
                    </div>
                    ...
                    {currentSubscription?.plan === 'Pro' ? (
                      ...
                      <Button 
                        onClick={() => handleUpgrade('Pro', 25000, 50, 500, 20)}
                        disabled={loadingSubscription}
                ...
                {/* Premium Plan */}
                <Card className={currentSubscription?.plan === 'Premium' ? 'border-2 border-yellow-600' : ''}>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      Plan Premium
                      {currentSubscription?.plan === 'Premium' && (
                        <Badge className="bg-yellow-600">Actuel</Badge>
                      )}
                    </CardTitle>
                    <CardDescription>Pour agences immobilières</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      <p className="text-3xl font-bold text-yellow-600">50,000 FCFA</p>
                      <p className="text-sm text-gray-600">par mois</p>
                    </div>
                    ...
                    {currentSubscription?.plan === 'Premium' ? (
                      ...
                      <Button 
                        onClick={() => handleUpgrade('Premium', 50000, 0, 0, 100)}
                        disabled={loadingSubscription}
              ...
              <Card>
                ...
                <CardContent>
                  {currentSubscription && currentSubscription.plan !== 'Gratuit' ? (
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium">Abonnement {currentSubscription.plan}</p>
                            <p className="text-sm text-gray-600">
                              {new Date(currentSubscription.created_at).toLocaleDateString('fr-FR', { 
                                day: 'numeric', 
                                month: 'long', 
                                year: 'numeric' 
                              })}
                        ...
                        <div className="text-right">
                          <p className="font-bold">{currentSubscription.price.toLocaleString()} FCFA</p>
                    ...
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <p className="text-sm">Passez à un plan payant pour commencer</p>
                    </div>
                  )}
                </CardContent>
              </Card>
              ...
              {/* Cancel Subscription */}
              {currentSubscription && currentSubscription.plan !== 'Gratuit' && currentSubscription.status === 'active' && (
                <Card className="border-red-200">
                  ...
                  <CardContent>
                    <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg">
                      <div>
                        <p className="font-medium text-red-900">Annuler l'abonnement</p>
