...
-- ========================================
-- 1. TABLE COMMUNAL_ZONES (Zones communales)
-- ========================================
...
-- ========================================
-- 2. TABLE DEVELOPER_PROJECTS (Projets promoteurs)
-- ========================================
...
CREATE INDEX IF NOT EXISTS idx_favorites_property ON favorites(property_id) WHERE property_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_favorites_zone ON favorites(communal_zone_id) WHERE communal_zone_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_favorites_project ON favorites(developer_project_id) WHERE developer_project_id IS NOT NULL;
