...
const VendeurDashboard = () => {
  ...
  const [dashboardData, setDashboardData] = useState({
    ...
    analytics: {
      ...
      conversionRate: 12.5,
      topPerformingProperty: 'Terrain résidentiel Sacré-Cœur'
    },
    inquiries: [
      {
        id: 1,
        propertyTitle: 'Terrain résidentiel Sacré-Cœur',
        buyerName: 'M. Diallo',
              ...
              <CardContent>
                <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-400">Intégration charts à venir</p>
                  </div>
                </div>
              </CardContent>
            </Card>
