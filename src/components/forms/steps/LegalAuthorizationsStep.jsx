...
const LegalAuthorizationsStep = ({ 
  ...
  const FileTexts = requiredFileTexts[currentRole] || [];
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Téléchargez les FileTexts requis pour votre rôle
        </p>
      </div>
      ...
      {FileTexts.length > 0 ? (
        <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-sm font-medium text-yellow-800">
                  FileTexts requis pour {formData.role}
                </h3>
                <p className="text-sm text-yellow-700 mt-1">
                  Veuillez télécharger tous les FileTexts obligatoires marqués d'un astérisque (*)
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• Les FileTexts doivent être au format PDF, JPG, PNG, DOC ou DOCX</li>
              <li>• Taille maximale par fichier: 10 MB</li>
              <li>• Les FileTexts seront vérifiés avant l'activation du compte</li>
              <li>• Assurez-vous que tous les FileTexts sont lisibles et à jour</li>
            </ul>
          </div>
        </div>
      ) : (
        <div className="text-center py-8">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">
            Aucun FileText requis
          </h3>
          <p className="text-gray-600">
            Votre rôle ne nécessite pas de FileTexts d'autorisation spécifiques.
          </p>
        </div>
      )}
