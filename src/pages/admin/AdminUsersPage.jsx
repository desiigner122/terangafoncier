...
import IntelligentUserWizard from './components/IntelligentUserWizard';
import FixedUserActions from './components/FixedUserActions';
...
const AdminUsersPage = () => {
  ...
  useEffect(() => {
    ...
    if (selectedVerification && selectedVerification !== 'all') {
      filtered = filtered.filter(user => user.verification_status === selectedVerification);
    }
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Select value={selectedVerification} onValueChange={setSelectedVerification}>
              ...
              <SelectContent>
                <SelectItem value="all">Toutes les vérifications</SelectItem>
