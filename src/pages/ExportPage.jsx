                      ...
                      <CardContent className="space-y-4">
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-3">
                            <h4 className="font-medium">Colonnes Ï  exporter ({selectedCount}/{totalColumns})</h4>
                            ...
                            <div>
                              ...
                              <div className="flex space-x-2 mt-1">
                                <DatePicker
                                  ...
                                  YOUR_API_KEYText="Date de début"
                                  className="flex-1"
                                />
                                <DatePicker
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              {config?.title} â€¢ {export_item.records} entrées â€¢ {export_item.size}
                            </p>
