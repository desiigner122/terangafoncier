...
(
  ...
  'Demande d''attribution de terrain pour projet industriel textile.',
...
(
  ...
  'Bonjour, j''aimerais avoir plus d''informations sur les charges de copropriété et la disponibilité pour une visite.'
),
(
